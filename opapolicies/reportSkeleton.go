    ...
    "eventsList": [
        ...
        },
        {
            ...
            "payload": {
                "machineID": "localhost.localdomain",
                "osProcessID": 1,
                "osProcessName": "/k8s-armo-collector",
                "processPriority": 0,
                "ASLR": 1,
                "osCGroup": 0,
                "stackProtection": 0,
        ...
        },
        {
            ...
            "payload": {
                ...
                "process_name": "/k8s-armo-collector",
                "component_level": "container",
                "imageHash": "docker-pullable://quay.io/armosec/k8s-armo-collector-ubi@sha256:754f3cfca915a07ed10655a301dd7a8dc5526a06f9bd06e7c932f4d4108a8296",
                "imageTag": "quay.io/armosec/k8s-armo-collector-ubi:latest",
