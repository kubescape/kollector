...
docker build --no-cache -t dreg.eust0.cyberarmorsoft.com:443/k8s-ca-dashboard-aggregator-t:8 .

rm -rf k8s-ca-dashboard-aggregator

docker push dreg.eust0.cyberarmorsoft.com:443/k8s-ca-dashboard-aggregator-t:8
