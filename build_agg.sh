...
docker build --no-cache -t dreg.eust0.cyberarmorsoft.com:443/k8s-ca-dashboard-aggregator:v2 -t dreg.eust0.cyberarmorsoft.com:443/k8s-ca-dashboard-aggregator:latest .
